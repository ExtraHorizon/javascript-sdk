...
export default (
  ...
  return {
    ...
    async findAll(options) {
      return findAllGeneric<OrderSchema>(find, options);
    },

    findAllIterator(options) {
      return findAllIterator<OrderSchema>(find, options);
    },
    ...
    async create(requestBody, options) {
      return (await client.post(httpAuth, '/orders', requestBody, options))
        .data;
    },
